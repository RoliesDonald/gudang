                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            ...
                            @section('breadcrumb')
                                @parent
                                <li class="breadcrumb-item active">Halaman Muka</li>
                            @show
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="text-center pt-3">
                            <div class="row">
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    <div class="d-inline-flex">
                                        ...
                                        <div class="text-success font-size-12">
                                            <i class="mdi mdi-menu-up font-size-14">
                                            </i>2.2 %
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    ...
                                    <p class="text-success text-truncate mb-0">
                                        Pending
                                    </p>
                                </div>
                                <!-- end col -->
                                <div class="col-sm-4">
                                    ...
                                    <p class="text-danger text-truncate mb-0">
                                        Re-Work
                                    </p>
