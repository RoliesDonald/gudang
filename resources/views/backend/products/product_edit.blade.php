                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endforeach @endif
                            <form method="post" action="{{ route('product.update') }}" id="newSupplierForm">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="supplier_id" id="" class="form-select"
                                            ...
                                            <option value="{{ $suppl->id }}" {{ $suppl->id == $products->supplier_id ?
                                                'selected':'' }}>
                                                {{ $suppl->name }}
                                            </option>
                                            @endforeach
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="category_id" id="" class="form-select"
                                            ...
                                            <option value="{{ $categ->id }}" {{ $categ->id == $products->category_id ?
                                                'selected':'' }}>
                                                {{ $categ->categoryname }}
                                            </option>
                                            @endforeach
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="unit_id" id="" class="form-select"
                                            ...
                                            @foreach ( $unit as $uni )
                                            <option value="{{ $uni->id }}" {{ $uni->id == $products->unit_id ?
                                                'selected':'' }}>
                                                {{ $uni->unitname }}
                                            </option>
                                            @endforeach
                                ...
                                <input class="btn btn-info waves-effect waves-light" type="submit"
                                    value="Update Product Data" name="" id="" />
                            </form>
                        </div>
                    </div>
                </div>
